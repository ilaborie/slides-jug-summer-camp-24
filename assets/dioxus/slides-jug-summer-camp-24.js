...
const XtermBridgeFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_xtermbridge_free(ptr >>> 0));
/**
*/
export class XtermBridge {
    ...
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        XtermBridgeFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_xtermbridge_free(ptr);
    }
    /**
    * @param {string} title
    */
    title(title) {
        ...
        wasm.xtermbridge_title(this.__wbg_ptr, ptr0, len0);
    }
    /**
    * @param {number} rows
    * @param {number} cols
    */
    resized(rows, cols) {
        ...
        _assertNum(rows);
        _assertNum(cols);
        wasm.xtermbridge_resized(this.__wbg_ptr, rows, cols);
    }
    /**
    */
    close() {
        if (this.__wbg_ptr == 0) throw new Error('Attempt to use a moved value');
        _assertNum(this.__wbg_ptr);
        wasm.xtermbridge_close(this.__wbg_ptr);
    }
}
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_highlightElement_2e413b100606e60d = function() { return logError(function (arg0) {
        Prism.highlightElement(getObject(arg0));
    }, arguments) };
    ...
    imports.wbg.__wbindgen_closure_wrapper1122 = function() { return logError(function (arg0, arg1, arg2) {
        const ret = makeClosure(arg0, arg1, 87, __wbg_adapter_48);
        return addHeapObject(ret);
    }, arguments) };
    imports.wbg.__wbindgen_closure_wrapper1250 = function() { return logError(function (arg0, arg1, arg2) {
        const ret = makeMutClosure(arg0, arg1, 112, __wbg_adapter_51);
        return addHeapObject(ret);
    }, arguments) };
    imports.wbg.__wbindgen_closure_wrapper1346 = function() { return logError(function (arg0, arg1, arg2) {
        const ret = makeMutClosure(arg0, arg1, 104, __wbg_adapter_54);
        return addHeapObject(ret);
    }, arguments) };
    imports.wbg.__wbindgen_closure_wrapper1391 = function() { return logError(function (arg0, arg1, arg2) {
        const ret = makeMutClosure(arg0, arg1, 104, __wbg_adapter_57);
        return addHeapObject(ret);
    }, arguments) };
    imports.wbg.__wbindgen_closure_wrapper1491 = function() { return logError(function (arg0, arg1, arg2) {
        const ret = makeMutClosure(arg0, arg1, 112, __wbg_adapter_57);
        return addHeapObject(ret);
    }, arguments) };
